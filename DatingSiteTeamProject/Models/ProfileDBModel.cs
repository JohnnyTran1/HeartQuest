...
namespace DatingSiteTeamProject.Models
{
    public class ProfileDBModel
    {
        ...
        public List<AuthenicationModel> SearchProfiles(int currentUser, string occupation, string city, string state, int lowerAge, int upperAge, string commitmentTypes)
        {
            ...
            //string commitment = string.Join("", commitmentTypes);
        ...
        //public List<DataPoint> GetUserMovieData()
        //{
        //    List<DataPoint> dataPoints = new List<DataPoint>();
        //    objCommand.Parameters.Clear();
        //    objCommand.CommandType = CommandType.StoredProcedure;
        //    objCommand.CommandText = "GetUserMoviePreferences";
        ...
        //            string movie = row["Movie"].ToString();
        //            string color = "Red";

        //            DataPoint point = new DataPoint(total, movie, color);
